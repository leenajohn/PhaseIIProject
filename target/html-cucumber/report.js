...
formatter.match({
  "location": "Saucedemo_LoginSteps.user_is_on_saucedemo_login_page()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "Saucedemo_LoginSteps.user_enters_something_and_something(String,String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "Saucedemo_LoginSteps.user_clicks_on_login_button()"
});
formatter.result({
  "status": "passed"
});
...
formatter.uri("file:src/test/java/features/Saucedemo_login.feature");
formatter.feature({
...
formatter.match({
  "location": "Saucedemo_LoginSteps.user_lands_on_the_product_page()"
});
formatter.result({
  "status": "passed"
});
